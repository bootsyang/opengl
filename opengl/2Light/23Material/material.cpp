...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader("../opengl/Shader/shaders/212colorObject.vs", "../opengl/Shader/shaders/231colorObject.fs");
    Shader lightShader("../opengl/Shader/shaders/211colorLight.vs", "../opengl/Shader/shaders/211colorLight.fs");
    ...
    Material Cyan;
    Cyan.Ambient = glm::vec3(0.0,	0.1,	0.06);
    Cyan.Diffuse = glm::vec3(0.0,	0.50980392,	0.50980392	);
    Cyan.Specular = glm::vec3(0.50196078,	0.50196078,	0.50196078	);
    Cyan.Shininess = 0.25;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setVec3("material.ambient",  Cyan.Ambient);
        ourShader.setVec3("material.diffuse",  Cyan.Diffuse);
        ourShader.setVec3("material.specular", Cyan.Specular);
        ourShader.setFloat("material.shininess", Cyan.Shininess);
